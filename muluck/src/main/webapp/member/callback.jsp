...
<body>
	<script type="text/javascript">
		...
		var naver_id_login = new naver_id_login("u4ZSMzPdnSJwhVD6Q0ZO", "http://localhost:8898/muluck/member/callback.jsp");
		...
		function naverSignInCallback() {
			...
			const member_ageRange = naver_id_login.getProfileData('age')
			...
			/*     alert("naverLogin?member_id=" + member_id + "&member_email=" + member_email  
			 ...
			 + "&member_gender=" + member_gender + "&member_ageRange=" + member_ageRange)
			 */
...
/* 			 //콘솔에 찍어보기
			...
			location.href = "naverLogin?member_id=" + member_id
					...
					+ "&member_ageRange=" + member_ageRange 
		}
	</script>
</body>
</html>