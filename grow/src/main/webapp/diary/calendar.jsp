            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto">
                        <li class="nav-item px-lg-4"><a class="nav-link text-uppercase" href="main/main.jsp">홈</a></li>
                        <li class="nav-item px-lg-4"><a class="nav-link text-uppercase" href="community/community.jsp">커뮤니티</a></li>
                        <li class="nav-item px-lg-4"><a class="nav-link text-uppercase" href="products.jsp">나의 식물</a></li>
                        <li class="nav-item px-lg-4"><a class="nav-link text-uppercase" href="business/business_main.jsp">거래</a></li>
                        <li class="nav-item px-lg-4"><a class="nav-link text-uppercase" href="card/card_main.jsp">MMTI</a></li>
                    </ul>
                </div>
            </div>
        </nav>
